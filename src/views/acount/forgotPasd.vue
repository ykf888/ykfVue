<template>
    <div class="login">
        <div class="loginBox">
            <h1 class="welcome texe-center">密码重置</h1>
            <el-form :model="formItem" :rules="rules" ref="getfrom">
                ...
                <el-form-item prop="passwordAgain">
                    <el-input type="password" v-model="formItem.passwordAgain" autocomplete="off"  placeholder="请再次输入密码" prefix-icon="iconfont icon-mima"></el-input>
                </el-form-item>
                ...
                <el-form-item>
                    <el-button type="primary" class="landing" @click="submitForm">重置密码</el-button>
                </el-form-item>
            </el-form>
...
import {computed, onMounted, reactive, toRefs,unref,ref,isRef, toRef,getCurrentInstance, watch} from "vue"
